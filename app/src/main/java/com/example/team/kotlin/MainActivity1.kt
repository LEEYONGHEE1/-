...
package com.example.team.kotlin
...
import com.examle.team.kotlin.model.Place
import com.examle.team.kotlin.model.getPositionVector

import com.example.team.R
import com.example.team.kotlin.api.NearbyPlacesResponse
import com.example.team.kotlin.api.PlacesService
import com.example.team.kotlin.ar.PlacesArFragment
...
import com.google.team.kotlin.ar.PlaceNode
...
class MainActivity1 : AppCompatActivity(), SensorEventListener {
    ...
    private fun setUpMaps() {
        ...
        mapFragment.getMapAsync { googleMap ->
            //noinspection MissingPermission -> 권한설정 오류해결
        ...
        placesService.nearbyPlaces(
            ...
            object : Callback<NearbyPlacesResponse> {
                ...
                override fun onResponse(
                    ...
                    this@MainActivity1.places = places
                }
            }
        )
    }
